...
export const register = (router: Router) => {
  ...
  router.post("/categories", AuthMiddleware, AdminMiddleware, (req, res) => create.run(req, res));
  router.put("/categories/:id", AuthMiddleware, AdminMiddleware, (req, res) => update.run(req, res));
};
