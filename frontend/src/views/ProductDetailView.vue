...
const product = {
  ...
  reviews: 124,
  description:
    "Fresh, creamy organic avocados sourced from certified organic farms. Perfect for guacamole, salads, or toast. Rich in healthy fats and nutrients. Each pack contains 4 ripe avocados ready to eat.",
  icon: "🥑",
  badge: "20% OFF",
...
const handleAddToCart = () => {
  cartStore.addItem({
    name: product.name,
    price: product.price,
    size: "4 pack", // Derived from unit or hardcoded
    icon: product.icon,
      ...
      <div class="container">
        <div class="product-grid">
          ...
          <div>
            <div class="product-image-section">
              ...
              <div class="product-main-image">{{ product.icon }}</div>
            </div>
        ...
        <div class="product-details-section">
          ...
          <div class="tab-content" :class="{ active: activeTab === 'storage' }">
            ...
            <p>
              <strong>If Ripe:</strong> Store in the refrigerator for up to 3-5
              days to extend freshness.
            </p>
            <p>
              <strong>Ripeness Check:</strong> Gently squeeze the avocado. If it
              yields slightly to pressure, it's ripe and ready to eat.
            </p>
            <p>
              <strong>After Cutting:</strong> Sprinkle lemon juice on exposed
              flesh and wrap tightly in plastic wrap. Store in refrigerator for
              up to 2 days.
            </p>
          </div>
        </div>
          ...
          <div class="products-grid">
            <a href="#" class="product-card">
              ...
              <div class="product-card-info">
                <div class="product-card-title">Fresh Strawberries</div>
                <div class="product-card-price">$4.49</div>
              </div>
            </a>
            <a href="#" class="product-card">
              <div class="product-card-image">🥬</div>
              <div class="product-card-info">
                <div class="product-card-title">Organic Spinach</div>
            ...
            <a href="#" class="product-card">
              <div class="product-card-image">🍅</div>
              <div class="product-card-info">
                <div class="product-card-title">Heirloom Tomatoes</div>
                <div class="product-card-price">$5.49</div>
              </div>
            </a>
            <a href="#" class="product-card">
              <div class="product-card-image">🥒</div>
              <div class="product-card-info">
                <div class="product-card-title">English Cucumber</div>
                <div class="product-card-price">$2.99</div>
              </div>
            </a>
          </div>
        </div>
